...
use crate::cartridge::mbc6::CartridgeMBC6;
...
macro_rules! dispatch_cartridge {
    ($self:expr, $method:ident ( $($arg:expr),* )) => {
        match $self {
            ...
            CartridgeKind::MBC6(c) => c.$method($($arg),*),
...
impl CartridgeKind {
    ...
    pub fn inner_cart_mut(&mut self) -> &mut Cartridge {
        match self {
            ...
            CartridgeKind::MBC6(c) => &mut c.cart,
...
pub fn load_rom(path: &str) -> (CartridgeKind, bool) {
    ...
    let cartridge = match cart_type {
        ...
        0x20 => CartridgeKind::MBC6(CartridgeMBC6::new(cart)),
