...
#[test]
fn boot_regs_dmg0() {
    let mut emulator = Gameboy::new("tests/mooneye/roms/boot_regs-dmg0.gb");
    assert!(emulator.passes_mooneye_test_rom());
}
...
#[test]
fn boot_regs_mgb() {
    let mut emulator = Gameboy::new("tests/mooneye/roms/boot_regs-mgb.gb");
    assert!(emulator.passes_mooneye_test_rom());
}
...
#[test]
fn boot_regs_sgb() {
    let mut emulator = Gameboy::new("tests/mooneye/roms/boot_regs-sgb.gb");
    assert!(emulator.passes_mooneye_test_rom());
}
...
#[test]
fn boot_regs_sgb2() {
    let mut emulator = Gameboy::new("tests/mooneye/roms/boot_regs-sgb2.gb");
    assert!(emulator.passes_mooneye_test_rom());
}
...
#[test]
fn boot_div_dmg0() {
    let mut emulator = Gameboy::new("tests/mooneye/roms/boot_div-dmg0.gb");
    assert!(emulator.passes_mooneye_test_rom());
}
...
#[test]
fn boot_hwio_dmg0() {
    let mut emulator = Gameboy::new("tests/mooneye/roms/boot_hwio-dmg0.gb");
    assert!(emulator.passes_mooneye_test_rom());
}
