...
fn sound_01_registers() {
    let mut emulator = Gameboy::new("tests/blargg/roms/dmg_sound/rom_singles/01-registers.gb");
    assert!(emulator.passes_blargg_ram_test_rom());
}

#[test]
fn sound_02_len_ctr() {
    let mut emulator = Gameboy::new("tests/blargg/roms/dmg_sound/rom_singles/02-len ctr.gb");
    assert!(emulator.passes_blargg_ram_test_rom());
}

#[test]
fn sound_03_trigger() {
    let mut emulator = Gameboy::new("tests/blargg/roms/dmg_sound/rom_singles/03-trigger.gb");
    assert!(emulator.passes_blargg_ram_test_rom());
}

#[test]
fn sound_04_sweep() {
    let mut emulator = Gameboy::new("tests/blargg/roms/dmg_sound/rom_singles/04-sweep.gb");
    assert!(emulator.passes_blargg_ram_test_rom());
}

#[test]
fn sound_05_sweep_details() {
    let mut emulator = Gameboy::new("tests/blargg/roms/dmg_sound/rom_singles/05-sweep details.gb");
    assert!(emulator.passes_blargg_ram_test_rom());
}
...
#[test]
fn sound_combined() {
    let mut emulator = Gameboy::new("tests/blargg/roms/dmg_sound/rom_singles/dmg_sound.gb");
    assert!(emulator.passes_blargg_ram_test_rom());
}
